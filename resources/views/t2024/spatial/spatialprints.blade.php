...
<head>
	...
	<meta name="description" content="Dokumen Daftar Spatial Lahan Wajib Tanam Produksi Bawang Putih">
	<meta name="author" content="Sistem Monitoring Wajib Tanam-Produksi Komoditas Hortikultura Strategis">
    <title>Autogenerated Daftar Spatial Lahan Wajib Tanam Produksi Bawang Putih</title>
		...
		<div class="container page-cover">
			<div class="row justify-content-between align-items-start">
				...
				<div class="col-12 d-flex align-items-start justify-content-center">
					...
					<div class="logo-text">
						<h1 class="mb-0 fw-bold">DAFTAR SPATIAL</h1>
						<p class="mb-3 h5 text-muted">LOKASI LAHAN WAJIB TANAM-PRODUKSI BAWANG PUTIH</p>
					</div>
				</div>
			</div>
			<hr>
			...
			<div class="row mb-3">
				<div class="col-12">
					...
					<table class="table table-bordered table-sm">
						<thead>
							<tr>
								<th class="text-center">Kode Spatial</th>
