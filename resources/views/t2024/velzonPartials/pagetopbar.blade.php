					...
					<div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
						<div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
							<div class="row align-items-center">
								...
								<div class="col-auto">
									<a href="pages-starter.html#!" class="btn btn-sm btn-soft-info"> View All
										Apps
								...
								<ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true"
									...
									<li class="nav-item waves-effect waves-light">
										<a class="nav-link active" data-bs-toggle="tab"
											href="pages-starter.html#all-noti-tab" role="tab"
											aria-selected="true">
											All (4)
										</a>
									</li>
									<li class="nav-item waves-effect waves-light">
										<a class="nav-link" data-bs-toggle="tab"
											href="pages-starter.html#messages-tab" role="tab"
											aria-selected="false">
											Messages
										</a>
									</li>
									<li class="nav-item waves-effect waves-light">
										<a class="nav-link" data-bs-toggle="tab"
											href="pages-starter.html#alerts-tab" role="tab"
											aria-selected="false">
											Alerts
										</a>
									</li>
								...
								<div data-simplebar style="max-height: 300px;" class="pe-2">
									<div
										...
										<div class="d-flex">
											...
											<div class="flex-grow-1">
												<a href="pages-starter.html#!" class="stretched-link">
					...
					<button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
						...
						<span class="d-flex align-items-center">
							@if (!empty(Auth::user()::find(Auth::user()->id)->data_user->avatar))
								<img class="rounded-circle header-profile-user" src="{{ asset('storage/' . Auth::user()->data_user->avatar) }}" alt="{{ Auth::user()->name }}">
							@else
								<img class="rounded-circle header-profile-user" src="{{asset('img/avatars/farmer.png') }}" alt="Default Avatar">
							@endif
							<span class="text-start ms-xl-2">
								<span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">
									{{ Auth::user()->data_user->company_name }}
								</span>
								<span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{Auth::user()->roles[0]->title}}</span>
							</span>
						</span>
					</button>
					<div class="dropdown-menu dropdown-menu-end">
						...
						<a class="dropdown-item"
							href="@if (Auth::user()->roleaccess == '1') {{ route('admin.profile.pejabat') }} @else {{ route('admin.profile.show') }} @endif">
							<i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
							<span class="align-middle">Profile</span>
						</a>
						<a class="dropdown-item" href="{{ trans('global.logout') }}" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">
