					...
					<div class="panel-container show">
						<div class="panel-content">
							<div class="panel-container show">
								...
								<form action="{{route('2024.verifikator.produksi.storeFinalCheck', [$ijin, $tcode])}}" method="POST" enctype="multipart/form-data">
									@csrf
									<div class="panel-content">
										...
										<div class="form-group row" id="ndhprtContainer" hidden>
											...
											<div class="col-md-9 col-lg-10">
												<div class="custom-file input-group">
													...
													<label class="custom-file-label" for="ndhprt">{{ old('fileNdhp', $verifikasi ? $verifikasi->fileNdhp : 'pilih berkas') }}</label>
												</div>
										...
										<div class="form-group row" id="batanamContainer" hidden>
											...
											<div class="col-md-9 col-lg-10">
												...
												@else
													<span class="help-block">Berita Acara Pemeriksaan Realisasi Produksi. PDF, max 2Mb.<span class="text-danger"></span></span>
												@endif
											</div>
										</div>
										<div class="form-group row">
