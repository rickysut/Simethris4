						...
						<form action="">
							<div class="form-group row">
								<div class="col-6">
									...
									<input type="text" id="nama_petani" name="nama_petani"  class="form-control @error('nama_petani') is-invalid @enderror" placeholder="nama_petani" value="" required>
									<span class="help-block" id="help-nama"></span>
								</div>
								<div class="col-6">
									<label class="form-label" for="ktp_petani">NIK <span class="text-danger">*</span></label>
									<input type="text" id="ktp_petani" name="ktp_petani"  class="form-control @error('ktp_petani') is-invalid @enderror" placeholder="ktp_petani" value="" required>
							...
							<div class="form-group row">
								<div class="col-md-6">
									...
									<input type="text" id="hp_petani" name="hp_petani" class="form-control @error('hp_petani') is-invalid @enderror" placeholder="No. Handphone" value="" required>
